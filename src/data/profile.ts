export const profile = {
  ...
  about: [
    ...
    'I also completed my internship at Akribian Edtech AB, where I worked on Count on Me, a science-based educational game for children. There, I implemented gameplay mechanics and interactive features in Unity, primarily using Playmaker alongside C#.',
  ...
  internship: {
    ...
    period: '2025',
    summary:
      'Implemented gameplay mechanics and interactive features for Count on Me, a science-based educational math game for children used in schools and at home.',
    highlights: [
      'Built interactive gameplay features in Unity with C# and Playmaker',
      'Worked in a professional edtech studio pipeline on a shipped product',
